...
export const NewCardsFragment = () => {
  return (
    <>
      <Card
        url="https://code.s3.yandex.net/teens/pindie-games/go-away/cover.jpg"
        name="Go Away"
      ...
      />
      <Card
        url="https://code.s3.yandex.net/teens/pindie-games/gunner/cover.png"
        name="G.U.N.N.E.R."
        description="Продержись как можно дольше, отбиваясь от врагов, которых будет становиться всё больше." author_name="IDKWIAm"
        voice="10"
      />
      <Card
        url="https://code.s3.yandex.net/teens/pindie-games/space-terror/cover.png"
        name="Terror"
        description="Лети как можно дальше в космическом пространстве, уничтожая всё на своём пути."
        author_name="IDKWIAm"
        voice="20"
      />
      <Card url="https://code.s3.yandex.net/teens/pindie-games/square-slayer/cover.png"
        name="Square Slayer"
