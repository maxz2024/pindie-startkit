...
export const PopularCardFragment = () => {
    return (
    <>
        <Card url="https://code.s3.yandex.net/teens/pindie-games/cristal-keeper/cover.png"
            name="Crystal Kepper"
            ...
            voice="20" />
        <Card url="https://code.s3.yandex.net/teens/pindie-games/dangeons-n-caves-prologue/cover.png"
            ...
            voice="10"
        />
        <Card url="https://code.s3.yandex.net/teens/pindie-games/defence-of-crystal/cover.png"
